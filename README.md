...
```
<p float="left">
  <img src="pic/introduction.gif" width="267" height="225"/>
  <img src="pic/introduction.jpg" width="267" height="225"/>
  <img src="pic/gif_highlight.gif" width="267" height="225"/>
</p>
...
## 0.1 Get a copy
```sh
git clone https://github.com/charles-alchemcy/AI_basketball_games_video_editor.git
```
...
- You can use `--output_mode shot` to select different output video mode.
  ...
  ```
![image](https://github.com/charles-alchemcy/AI_basketball_games_video_editor/blob/master/pic/output_mode_clean.jpg)
![image](https://github.com/charles-alchemcy/AI_basketball_games_video_editor/blob/master/pic/output_mode_full.jpg)
![image](https://github.com/charles-alchemcy/AI_basketball_games_video_editor/blob/master/pic/output_mode_basketball.jpg)
![image](https://github.com/charles-alchemcy/AI_basketball_games_video_editor/blob/master/pic/output_mode_shot.jpg)
