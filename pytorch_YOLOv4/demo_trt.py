...
class Yolov4TrtEngine(object):
    
    def __init__(self, weight_path, namesfile_path, inference_size, num_classes):
        
        engine = get_engine(weight_path)
        self.engine = engine
    ...
    def detect(self, context, buffers, image_src, image_size, num_classes):
        IN_IMAGE_H, IN_IMAGE_W = image_size
    ...
    def detect_image(self, image_src):
        ...
        boxes = self.detect(self.context, self.buffers, image_src, self.image_size, self.num_classes)
